...
{
    public abstract class LanguageLearningWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LanguageLearningWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LanguageLearningWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LanguageLearningDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LanguageLearningDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LanguageLearningDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LanguageLearningDbContext, Task<T>> func)
        {
            T result;
